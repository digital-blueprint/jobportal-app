...
export class BaseFormElement extends ScopedElementsMixin(DBPLitElement) {
    ...
    connectedCallback() {
        ...
        this.updateComplete.then(() => {
            ...
            this.addEventListener(
                'DbpJobportalFormToggleSubmissionState',
    ...
    async toggleSubmissionState(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormToggleSubmissionState', {
            detail: data,
            bubbles: true,
            composed: true,
        });
    ...
    sendSubmission(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormSubmission', {
            detail: data,
            bubbles: true,
            composed: true,
        });
    ...
    async sendSaveDraft(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormSaveDraft', {
            bubbles: true,
            composed: true,
            detail: data,
        });
    ...
    sendDeleteSubmission(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormDeleteSubmission', {
            bubbles: true,
            composed: true,
            detail: data,
        });
    ...
    async sendSaveSubmission(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormSaveSubmission', {
            bubbles: true,
            composed: true,
            detail: data,
        });
    ...
    resetForm(event) {
        ...
        const customEvent = new CustomEvent('DbpJobportalFormReset', {
            bubbles: true,
            composed: true,
        });
        this.dispatchEvent(customEvent);
    ...
    async displayErrors(response) {
        ...
        if (responseBody['relay:errorId'] === 'jobportal:submission-data-feed-invalid-schema') {
    ...
    _buildSubmissionUrl(submissionId = null) {
        const baseUrl = `${this.entryPointUrl}/jobportal/submissions`;
