...
export class CustomTabulatorTable extends TabulatorTable {
    static get scopedElements() {
        return {
            'dbp-jobportal-column-settings-button': ColumnSettingsButton,
            'dbp-jobportal-get-details-button': GetDetailsButton,
            'dbp-jobportal-get-submission-link': GetSubmissionLink,
        };
    }
