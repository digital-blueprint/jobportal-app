...
class JobportalFormElement extends BaseFormElement {
    ...
    /**
     * Reset submission / state related fields end emit DbpJobportalFormReset event.
     */
    resetForm(event) {
    ...
    static get styles() {
        ...
        return [
            ...
            // language=css
            css`
                @layer theme, utility, jobportal, print;
                @layer theme {
    ...
    connectedCallback() {
        ...
        this.updateComplete.then(() => {
            ...
            this.addEventListener('DbpJobportalFormSaveDraft', this.handleSaveDraft);

            // Event listener for form submission
            this.addEventListener('DbpJobportalFormSubmission', this.handleFormSubmission);

            // Event listener for delete submission
            this.addEventListener(
                'DbpJobportalFormDeleteSubmission',
                this.handleFormDeleteSubmission,
            );
            // Event listener for save/PATCH submission
            this.addEventListener('DbpJobportalFormSaveSubmission', this.handleFormSaveSubmission);
    ...
    disconnectedCallback() {
        ...
        this.removeEventListener('DbpJobportalFormSaveDraft', this.handleSaveDraft);
        this.removeEventListener('DbpJobportalFormSubmission', this.handleFormSubmission);
        this.removeEventListener(
            'DbpJobportalFormDeleteSubmission',
            this.handleFormDeleteSubmission,
        );

        this.removeEventListener('DbpJobportalFormSaveSubmission', this.handleFormSaveSubmission);
    ...
    async handleSaveDraft(event) {
        ...
        formData.append('form', '/jobportal/forms/' + this.formIdentifier);
    ...
    async apiGetResourceActionGrants() {
        ...
        return await httpGetAsync(
            this.entryPointUrl +
                `/authorization/resource-action-grants?resourceClass=DbpRelayJobportalSubmission&resourceIdentifier=${this.submissionId}&page=1&perPage=9999`,
            options,
        );
    }
