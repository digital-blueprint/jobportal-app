...
class JobportalFormElement extends BaseFormElement {
    ...
    connectedCallback() {
        ...
        this.updateComplete.then(() => {
            ...
            this.addEventListener('DbpJobportalFormSubmission', async (event) => {
                ...
                postFormData.append('form', '/jobportal/forms/' + this.formIdentifier);
                ...
                try {
                    ...
                    const url = `${this.entryPointUrl}/jobportal/submissions`;
    ...
    // Or you can add a custom event listener for "DbpJobportalFormSubmission" to handle the form data (see connectedCallback)
    /*
    ...
    */
    ...
    render() {
        console.log('-- Render JobportalFormElement --');
